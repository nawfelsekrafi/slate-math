...
export const MENTIONABLES: TComboboxItem<MentionEquationData>[] = [  
  ...
  { key: '3', data:  { node: undefined,  value:    '\u003E'}, text: 'greaterthan'},
  { key: '4', data:  { node: undefined,  value:    '\u003C'}, text: 'lessthan'},
  { key: '5', data:  { node: undefined,  value:    '\u2265'}, text: 'greaterthanorequalto'},
  { key: '6', data:  { node: undefined,  value:    '\u2264'}, text: 'lessthanorequalto'},
  { key: '7', data:  { node: undefined,  value:    '\u0028'}, text: 'leftparenthesis'},
  { key: '8', data:  { node: undefined,  value:    '\u0029'}, text: 'rightparenthesis'},
  { key: '9', data:  { node: undefined,  value:    '\u005B'}, text: 'leftsquarebracket'},
  { key: '10', data: { node: undefined,  value:    '\u005D'}, text: 'rightsquarebracket'},
  { key: '11', data: { node: undefined,  value:    '\u002B'}, text: 'plus'},
  { key: '12', data: { node: undefined,  value:    '\u2212'}, text: 'minus'},
  { key: '13', data: { node: undefined,  value:    '\u00B1'}, text: 'plusorminus'},
  { key: '14', data: { node: undefined,  value:    '\u2213'}, text: 'minusorplus'},
  { key: '15', data: { node: undefined,  value:    '\u2217'}, text: 'multiplicationstar'},
  { key: '16', data: { node: undefined,  value:    '\u00D7'}, text: 'multiplicationcross'},
  { key: '17', data: { node: undefined,  value:    '\u22C5'}, text: 'multiplicationdot'},
  { key: '18', data: { node: undefined,  value:    '\u00F7'}, text: 'divisionsymbol'},
  { key: '19', data: { node: undefined,  value:    '\u2215'}, text: 'divisionslash'},
  { key: '20', data: { node: undefined,  value:    'mod'}, text: 'modulo'},
  { key: '21', data: { node: undefined,  value:    '\u2038'}, text: 'caret'},
  { key: '22', data: { node: undefined,  value:    '\u221A'}, text: 'squareroot'},
  { key: '23', data: { node: undefined,  value:    '\u221B'}, text: 'cuberoot'},
  { key: '24', data: { node: undefined,  value:    '\u221C'}, text: 'fourthroot'},
  { key: '25', data: { node: undefined,  value:    '\u0025'}, text: 'percent'},
  { key: '26', data: { node: undefined,  value:    '\u2030'}, text: 'permille'},
  { key: '27', data: { node: undefined,  value:    'ppm'}, text: 'permillion'},
  { key: '28', data: { node: undefined,  value:    'ppb'}, text: 'perbillion'},
  { key: '29', data: { node: undefined,  value:    'ppt'}, text: 'pertrillion'},
  { key: '30', data: { node: undefined,  value:    '\u00B0'}, text: 'degree'},
  { key: '31', data: { node: undefined,  value:    '\u2032'}, text: 'prime'},
  { key: '32', data: { node: undefined,  value:    '\u2033'}, text: 'doubleprime'},
  { key: '33', data: { node: undefined,  value:    '\u007E'}, text: 'approximationtilde'},
  ...
  { key: '39', data: { node: undefined,  value:    '\u007B'}, text: 'leftbrace'},
  { key: '40', data: { node: undefined,  value:    '\u007D'}, text: 'rightbrace'},
  { key: '41', data: { node: undefined,  value:    '\u230A'}, text: 'leftfloor'},
  { key: '42', data: { node: undefined,  value:    '\u230B'}, text: 'rightfloor'},
  { key: '43', data: { node: undefined,  value:    '\u2308'}, text: 'leftceiling'},
  { key: '44', data: { node: undefined,  value:    '\u2309'}, text: 'rightceiling'},
  { key: '45', data: { node: undefined,  value:    '\u0021'}, text: 'factorial'},
  { key: '46', data: { node: undefined,  value:    '\u007C'}, text: 'absolutevaluebrace'},
  ...
  { key: '52', data: { node: undefined,  value:    'ln'}, text: 'naturallog'},
